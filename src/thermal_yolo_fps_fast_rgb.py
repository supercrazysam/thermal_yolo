...
import external_yolov4.darknet.darknet as darknet 
...
print(cwd)
configPath = cwd+"/external_yolov4/darknet/yolov4.cfg"
weightPath = cwd+"/external_yolov4/darknet/yolov4.weights"
metaPath   = cwd+"/external_yolov4/darknet/cfg/coco_yolov4_rgb.data"
